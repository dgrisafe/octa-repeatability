...
<span style="color:red">Note to Dom: Something weird is occurring with Table 1...need to debug because it shows 82 glaucoma patients, but we're saying only 81 when looking directly at the data (above).</span> 
